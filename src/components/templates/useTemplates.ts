...
export const defaultTemplates: Template[] = [
  {
    ...
    description:
      "Template professionnel pour présentations client avec slides de titre, problème, solution, marché et appel à l'action.",
    category: "pitch-deck",
    ...
    defaultVariables: [
      {
        ...
        defaultValue: "Votre Société",
        type: "text",
      },
      {
        key: "tagline",
        label: "Slogan",
        defaultValue: "Votre proposition de valeur",
        type: "text",
      },
      {
        key: "problemDescription",
        label: "Description du problème",
        defaultValue: "Décrivez le problème que vous résolvez...",
        type: "text",
      },
      {
        key: "solutionDescription",
        label: "Description de la solution",
        defaultValue: "Expliquez votre solution innovante...",
        type: "text",
      },
      {
        key: "marketData",
        label: "Données de marché",
        defaultValue: "TAM, SAM, SOM...",
        type: "text",
      },
      {
        key: "contactInfo",
  ...
  },
  {
    ...
    description:
      "Template complet pour levée de fonds incluant business model, traction, équipe et projections financières.",
    ...
    defaultVariables: [
      ...
      },
      {
        ...
        defaultValue: "Notre vision est de...",
        type: "text",
      },
      {
        key: "tractionMetrics",
        label: "Métriques de traction",
        defaultValue: "Revenus, utilisateurs, croissance...",
        type: "text",
      },
      {
        key: "businessModel",
        label: "Business Model",
        defaultValue: "Description du modèle économique...",
        type: "text",
      },
      {
        key: "teamMembers",
        label: "Membres de l'équipe",
        defaultValue: "Présentation des fondateurs...",
        type: "text",
      },
      {
        key: "financialProjections",
        label: "Projections financières",
        defaultValue: "Revenus sur 5 ans...",
        type: "text",
      },
      {
        key: "fundUsage",
        label: "Utilisation des fonds",
        defaultValue: "Répartition du budget...",
        type: "text",
      },
    ],
  },
  {
    ...
    description:
      "Template structuré pour la présentation d'une cession d'entreprise avec valorisation et due diligence.",
    category: "cession",
    ...
    defaultVariables: [
      ...
      },
      {
        ...
        defaultValue: "Historique, activité, positionnement...",
        type: "text",
      },
      {
        key: "financialHistory",
        label: "Historique financier",
        defaultValue: "CA, EBITDA, résultats sur 3 ans...",
        type: "text",
      },
      {
        key: "valuationDetails",
        label: "Détails de valorisation",
        defaultValue: "Méthodes et résultats...",
        type: "text",
      },
      {
        key: "keyStrengths",
        label: "Points forts",
        defaultValue: "Atouts stratégiques...",
        type: "text",
      },
      {
        key: "saleProcess",
        label: "Processus de cession",
        defaultValue: "Calendrier et étapes...",
        type: "text",
      },
    ],
  },
  {
    ...
    description:
      "Template pour présenter une opportunité d'acquisition avec analyse stratégique et synergies.",
    ...
    defaultVariables: [
      {
        key: "targetCompany",
        label: "Société cible",
        defaultValue: "Cible XYZ",
        type: "text",
      },
      {
        key: "targetProfile",
        label: "Profil de la cible",
        defaultValue: "Description de l'entreprise cible...",
        type: "text",
      },
      {
        key: "strategicRationale",
        label: "Rationale stratégique",
        defaultValue: "Pourquoi cette acquisition ?",
        type: "text",
      },
      {
        key: "synergies",
        label: "Synergies",
        defaultValue: "Synergies opérationnelles et financières...",
        type: "text",
      },
      {
        key: "dealStructure",
        label: "Structure de l'opération",
        defaultValue: "Prix, modalités, financement...",
        type: "text",
      },
      {
        key: "integrationPlan",
        label: "Plan d'intégration",
        defaultValue: "Étapes et calendrier...",
        type: "text",
      },
    ],
  },
  {
    ...
    description:
      "Template pour présentations de financements complexes : LBO, project finance, dette structurée.",
    ...
    defaultVariables: [
      ...
      },
      {
        ...
        label: "Structure du financement",
        defaultValue: "Détails de la structure...",
        type: "text",
      },
      {
        key: "financingTable",
        label: "Tableau de financement",
        defaultValue: "Sources et emplois...",
        type: "text",
      },
      {
        key: "projectedCashflows",
        label: "Cash flows projetés",
        defaultValue: "Prévisions de remboursement...",
        type: "text",
      },
      {
        key: "securityPackage",
        label: "Sécurisations",
        defaultValue: "Gages et garanties...",
        type: "text",
      },
      {
        key: "riskAnalysis",
        label: "Analyse de risque",
        defaultValue: "Risques et mitigations...",
        type: "text",
      },
    ],
  },
  {
    ...
    description:
      "Template polyvalent pour rapports financiers, analyses de marché et notes de synthèse.",
    category: "rapport",
    ...
    defaultVariables: [
      {
        ...
        defaultValue: "Rapport d'Analyse",
        type: "text",
      },
      {
        key: "reportSubtitle",
        label: "Sous-titre",
        defaultValue: "Période d'analyse",
        type: "text",
      },
      {
        key: "executiveSummary",
        label: "Executive Summary",
        defaultValue: "Synthèse des points clés...",
        type: "text",
      },
      {
        key: "contextObjectives",
        label: "Contexte et objectifs",
        defaultValue: "Cadre de l'étude...",
        type: "text",
      },
      {
        key: "analysisData",
        label: "Analyse et données",
        defaultValue: "Résultats de l'analyse...",
        type: "text",
      },
      {
        key: "recommendations",
        label: "Recommandations",
        defaultValue: "Actions recommandées...",
        type: "text",
      },
      {
        key: "conclusion",
        label: "Conclusion",
        defaultValue: "Conclusion générale...",
        type: "text",
      },
    ],
  },
  {
    ...
    description:
      "Template pour présenter l'équipe dirigeante, les experts et les collaborateurs clés.",
    category: "equipe",
    ...
    defaultVariables: [
      {
        key: "companyName",
        label: "Nom de l'entreprise",
        defaultValue: "Notre Entreprise",
        type: "text",
      },
      {
        key: "leadershipTeam",
        label: "Équipe de direction",
        defaultValue: "Présentation des dirigeants...",
        type: "text",
      },
      {
        key: "salesTeam",
        label: "Équipe commerciale",
        defaultValue: "Présentation commerciale...",
        type: "text",
      },
      {
        key: "companyCulture",
        label: "Culture d'entreprise",
        defaultValue: "Nos valeurs et notre culture...",
        type: "text",
      },
      {
        key: "joinUs",
        label: "Nous rejoindre",
        defaultValue: "Opportunités de carrière...",
        type: "text",
      },
    ],
  },
  {
    ...
    description:
      "Template pour présenter le portefeuille clients, les études de cas et les témoignages.",
    category: "references",
    ...
    defaultVariables: [
      {
        ...
        defaultValue: "Liste des clients...",
        type: "text",
      },
      {
        key: "caseStudy1",
        label: "Étude de cas 1",
        defaultValue: "Premier cas client...",
        type: "text",
      },
      {
        key: "caseStudy2",
        label: "Étude de cas 2",
        defaultValue: "Deuxième cas client...",
        type: "text",
      },
      {
        key: "testimonials",
        label: "Témoignages",
        defaultValue: "Avis clients...",
        type: "text",
      },
    ],
  },
...
export const categoryLabels: Record<TemplateCategory | "all", string> = {
  ...
  custom: "Mes Modèles",
  cession_vente: "Cession/Vente",
  acquisition_achats: "Acquisition/Achats",
  lbo_levee_fonds: "LBO/Levée de fonds",
  fusion_partenariat: "Fusion/Partenariat",
  ipo: "IPO",
};
...
export function useTemplates() {
  ...
  const applyTemplate = useCallback(
    (template: Template, variableValues?: Record<string, string>) => {
        ...
        if (variableValues) {
          Object.entries(variableValues).forEach(([key, value]) => {
            ...
            if (processedSlide.title) {
              processedSlide.title = processedSlide.title.replace(
                placeholder,
                value,
              );
            }
            if (processedSlide.subtitle) {
              processedSlide.subtitle = processedSlide.subtitle.replace(
                placeholder,
                value,
              );
            }
            if (processedSlide.content) {
              processedSlide.content = processedSlide.content.replace(
                placeholder,
                value,
              );
            }
