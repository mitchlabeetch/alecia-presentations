      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-white flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          <div className="hidden sm:flex items-center gap-1.5">
            <div
              className={`w-1.5 h-1.5 rounded-full ${saveStatus.dot} ${autoSaveStatus === 'saving' ? 'animate-pulse' : ''}`}
            />
            <span className={`text-[10px] font-medium ${saveStatus.color}`}>
              {saveStatus.label}
            </span>
          </div>
      ...
      <div className="flex border-b border-gray-100 bg-white flex-shrink-0">
        ...
        {tab === 'edit' && (
          <div className="ml-auto flex items-center px-3">
            ...
            >
              <span
                className={`w-1.5 h-1.5 rounded-full ${useCollaborative ? 'bg-emerald-500 animate-pulse-dot' : 'bg-gray-400'}`}
              />
        ...
        {tab === 'preview' && (
          <div className="ml-auto flex items-center px-4">
            <span className="text-[10px] text-gray-400">
              Clic sur un bloc pour éditer · Clic droit pour options
            </span>
          </div>
        )}
      </div>
            ...
            <div className="relative w-full" style={{ maxWidth: '800px' }}>
              ...
              >
                ...
                <div className="absolute -top-6 left-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                  <span className="bg-[#c9a84c] text-white text-[9px] font-bold px-2 py-0.5 rounded-md shadow-sm whitespace-nowrap">
                    ✏️ Titre
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <div className="absolute -top-6 left-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                  <span className="bg-[#1a3a5c] text-white text-[9px] font-bold px-2 py-0.5 rounded-md shadow-sm whitespace-nowrap">
                    ✏️ Contenu
                  </span>
                </div>
              </div>
        ...
        {tab === 'comments' && (
          <div className="flex-1 overflow-hidden">
            <CommentsPanel
              slideId={slide._id}
              projectId={slide.projectId}
              slide={{ ...slide, title, content, type }}
            />
          </div>
        )}
          ...
          >
            <div className="px-3 py-1.5 border-b border-gray-100 mb-1">
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wide">
                {contextMenu.field === 'title'
                  ? '📌 Titre'
                  : contextMenu.field === 'content'
                    ? '📝 Contenu'
                    : '🗒 Notes'}
              </p>
            </div>
